...
Root: "HKCU"; Subkey: "Software\Classes\Directory\shell\Blink\shell\cmd4";         ValueType: string ;  ValueName: "Icon";            ValueData: """{userappdata}\Blink\lightbulb.ico""";                        Flags: uninsdeletekey
